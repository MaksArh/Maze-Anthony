    ...
    <body>
        ...
        <div class="container-fluid">
            <div class="row p-3">
                <div class="col-md-4 p-3 content ">
                    <form method="post" action="">
                        <label class="form-label" for="arr">
                            <h4>Введите лабиринт в виде двумерного массива, элементы можно не разделять, или разделять следующими знаками:<br>"(" "[" "," "пробел". <br>
                            Строки необходимо разделить с помощью одного из следующих символов: <br>
                            "]" ")" "\n" - перенос строки. </h4>
                        </label>
                        <br>
                ...
                <div class="col-md-2 col-sm-auto"></div>
